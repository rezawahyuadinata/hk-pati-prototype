    ...
    $(function () {
        ...
        function initOwlCarousel(c) {
            ...
            c.owlCarousel({
                ...
                autoplayHoverPause:
                    c.attr("data-autoplay-hover-pause") === "true",
        ...
        if (plugins.facebookWidget.length) {
            lazyInit(plugins.facebookWidget, function () {
                (function (d, s, id) {
                    ...
                    js.id = id;
                    js.src =
                        "//connect.facebook.net/en_EN/sdk.js#xfbml=1&version=v2.5";
        ...
        if (plugins.multitoggles.length) {
            for (var i = 0; i < plugins.multitoggles.length; i++) {
                ...
                if (
                    plugins.multitoggles[i].classList.contains("content-toggle")
                ) {
