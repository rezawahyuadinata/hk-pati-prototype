                    ...
                    <div class="rd-navbar-inner rd-navbar-search-wrap">
                        ...
                        <div class="rd-navbar-panel rd-navbar-search-lg_collapsable">
                            ...
                            <div class="rd-navbar-brand"><a class="brand-name" href="index.html"><img
                                        src="{{ asset('storage/assets/img/logo/logo_hkpati.gif') }}" alt=""
                                        width="149" height="42"
                                        srcset="{{ asset('storage/assets/img/logo/logo_hkpati.gif') }} 2x" /></a>
                            </div>
                        </div>
                        <!-- RD Navbar Nav-->
            ...
            <div class="container">
                <div class="row justify-content-sm-center justify-content-lg-start row-30 row-md-60">
                    <div class="col-sm-10 col-md-6 col-lg-10 col-xl-3"><a class="brand" href="index.html"><img
                                src="{{ asset('storage/assets/img/hero/hkp.PNG') }}" alt="" width="149"
                                height="42" srcset="images/logo-inverse-298x84.png 2x" /></a>
