...
@section('content')
    ...
    <section class="section section-layout-1 novi-section novi-background">
        ...
        <div class="section-layout-aside">
            <div class="section-layout-aside__item"><a class="thumb-modern" href="#"><img class="thumb-modern__image"
                        src="{{ asset('assets/img/hero/hkpati.JPG') }}" alt="" width="538" height="200" />
            ...
            <div class="section-layout-aside__item"><a class="thumb-modern" href="#"><img
                        class="thumb-modern__image" src="{{ asset('assets/img/hero/hkpati.JPG') }}" alt=""
                        width="498" height="195" />
                    <div class="thumb-modern__caption">
                    ...
                    <div class="range range-sm-center range-md-left range-md-middle range-50">
                        ...
                        <div class="cell-sm-10 cell-md-7 cell-xl-6">
                            <div class="box-spacer-left box-spacer-left-lg"><img
                                    src="{{ asset('assets/img/hero/h3_hero.JPG') }}" alt="" width="731"
                                    height="361" />
                            </div>
                        </div>
                    </div>
    ...
    <section class="section section-md bg-white text-center novi-background bg-cover">
        ...
        <div class="shell-fluid">
            <div class="range range-condensed range-md-reverse range-flex">
                <div class="cell-md-6 bg-gray-dark bg-image novi-background custom-bg-image"
                    ...
                    <div class="section-variant-1">
                        ...
                        <div class="owl-carousel owl-carousel_style-3" data-items="1" data-autoplay="true"
                            data-dots="true" data-nav="true" data-stage-padding="0" data-loop="true" data-margin="30"
                            data-mouse-drag="false">
                            <div class="item">
                                <!-- Quote light-->
                                <article class="quote-light">
                                    <div class="quote-light__image-wrap"><img class="quote-light__image"
                                            src="{{ asset('assets/images/testimonials-1-88x88.jpg') }}" alt=""
                                            width="88" height="88" />
                                    </div>
                            ...
                            <div class="item">
                                ...
                                <article class="quote-light">
                                    <div class="quote-light__image-wrap"><img class="quote-light__image"
                                            src="{{ asset('assets/images/testimonials-2-88x88.jpg') }}" alt=""
                                            width="88" height="88" />
                                    </div>
                                    <div class="quote-light__main">
                            ...
                            <div class="item">
                                ...
                                <article class="quote-light">
                                    <div class="quote-light__image-wrap"><img class="quote-light__image"
                                            src="{{ asset('assets/images/testimonials-3-88x88.jpg') }}" alt=""
                                            width="88" height="88" />
                                    </div>
                                    <div class="quote-light__main">
                ...
                <div class="cell-md-6">
                    <div class="link-block-group novi-section"><a class="link-block link-block-light novi-background"
                            href="#"><img src="{{ asset('assets/images/brand-1-216x102.png') }}" alt=""
                                width="216" height="102" /></a><a class="link-block novi-background"
                            href="#"><img src="{{ asset('assets/images/brand-2-155x34.png') }}" alt=""
                                width="155" height="34" /></a><a class="link-block novi-background"
                            href="#"><img src="{{ asset('assets/images/brand-3-122x33.png') }}" alt=""
                                width="122" height="33" /></a><a
                            class="link-block link-block-light novi-background" href="#"><img
                                src="{{ asset('assets/images/brand-4-100x76.png') }}" alt="" width="100"
                                height="76" /></a></div>
                </div>
            </div>
        </div>
        ...
        <div class="shell shell-wide">
            <div class="range range-md-center range-fix">
                <div class="cell-lg-11">
                    ...
                    <div class="section__header">
                        <h2>News</h2>
                        <div class="section__header-element"><a class="link link-arrow" href="news.html"><span>Read Our
                                    News</span></a></div>
                    </div>
                    ...
                    <div class="layout-bordered__main-inner">
                        ...
                        <form class="rd-mailform" data-form-output="form-output-global" data-form-type="contact"
                            ...
                            <div class="range range-fix range-sm-bottom range-20">
                                <div class="cell-sm-6">
                                    <div class="form-wrap">
                                        <input class="form-input form-control-has-validation" id="contact-first-name"
                                            type="text" name="first-name" data-constraints=""><span
