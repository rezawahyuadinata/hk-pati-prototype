    ...
    <div class="page">
        ...
        <section>
            <div class="swiper-container swiper-slider swiper-slider_fullheight bg-gray-dark" data-simulate-touch="false"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide text-center" data-slide-bg="{{ asset('storage/assets/img/hero/hkpati.JPG') }}">
                    ...
                    <div class="swiper-slide text-center" data-slide-bg="{{ asset('storage/assets/img/hero/part.JPG') }}">
                        <div class="swiper-slide-caption">
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-lg-10">
                    ...
                    <div class="swiper-slide text-center" data-slide-bg="{{ asset('storage/assets/img/hero/part1.jpg') }}">
                        <div class="swiper-slide-caption">
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-lg-10">
            ...
            <div class="container">
                ...
                <div class="row justify-content-md-center row-30 row-md-50 text-left">
                    <div class="col-md-11 col-lg-10 col-xl-6">
                        <img src="{{ asset('storage/assets/img/hero/h1_hero.jpg') }}" alt="">
                    </div>
                    <div class="col-md-11 col-lg-10 col-xl-6">
                        <h4>Vission</h4>
                ...
                <div class="row justify-content-md-center row-30 row-md-50 text-left">
                    ...
                    <div class="col-md-11 col-lg-10 col-xl-6">
                        <img src="{{ 'storage/assets/img/hero/h3_hero.JPG' }}" alt="">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="bg-gray-lighter novi-background object-wrap"
            ...
            <div class="object-wrap__body object-wrap__body-sizing-1 object-wrap__body-md-right bg-image"
                style="background-image: url({{ asset('assets/img/hero/hkpati.JPG') }})"></div>
        </section>
