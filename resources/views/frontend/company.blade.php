...
@section('content')
                    ...
                    <div class="container">
                        <div class="row justify-content-sm-center">
                            <div class="col-md-10 col-xl-8">
                                <h2 class="heading-decorated">Company Profile</h2>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="page">
        <section class="section-md novi-background bg-gray-lighter"
        ...
        {{-- <section class="section-md bg-default novi-background"
            ...
            <div class="container">
                <div class="row justify-content-md-center flex-xl-row-reverse row-30 row-md-50">
                    <div class="col-md-11 col-lg-10 col-xl-6">
                        <h4 class="heading-decorated">Construction Management</h4>
                        <p class="heading-6">Construction project management is essential. We're using the most time and
                            iterations efficient life cycles for that.</p>
                        <p>As you may know, the construction planning process has always been far from perfect... In the
                            past, project schedules were unrealistically optimistic... That resulted in an average of 45% of
                            work promised in a week actually being completed at a later date than its deadline dictated.
                            This kind of protraction left subcontractors waiting for the previous task to be completed, even
                            before the next stage of work could have proceeded further... To fix that issue, our
                            construction bureau have implemented the Pull Planning process, coordinated with the trade
                            contractors on a weekly basis. Pull Planning method estimates the scheduling in reverse.</p><a
                            class="button button-primary" href="single-service.html">Read more</a>
                    </div>
                    <div class="col-md-11 col-lg-10 col-xl-6"><img src="images/service-2-652x491.jpg" alt=""
        ...
        <section class="section-md bg-default novi-background text-center"
            data-preset="{&quot;title&quot;:&quot;Testimonials 2&quot;,&quot;category&quot;:&quot;testimonials&quot;,&quot;reload&quot;:true,&quot;id&quot;:&quot;testimonials-2&quot;}">
            <div class="container">
                <h4 class="heading-decorated">VISI & MISI</h4>
                <div class="row row-50">
                    <div class="col-md-6">
                        <!-- Quote default-->
                        <div class="quote-default quote-default_left">
                            <div class="icon-container" aria-label="Visi Icon">
                                <svg version="1.1" baseProfile="tiny" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="30.234px" height="23.484px" viewBox="0 0 30.234 23.484" xml:space="preserve">
                                    <g>
                                        <path
                                ...
                                <span class="heading-6">Visi</span>
                            </div>
                            <div class="quote-default__text">
                                <p class="q">As an official fro North Dakota's state government, I want to thank your
                                    construction company. On behalf of the citizens of the state, we're so grateful for this
                                    new, innovative building! This allows North Dakota to hold its legislative operations in
                                    a contemporary, progressive architectural environment!</p>
                            </div>
                            <p class="quote-default__cite">Deborah Quagmire</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <!-- Quote default -->
                        <div class="quote-default quote-default_left">
                            <div class="icon-container" aria-label="Visi Icon">
                                ...
                                <span class="heading-6">Misi</span>
                            </div>
                            <div class="quote-default__text">
                                <p class="q">This bridge project was funded by small and medium business of Rhode
                                    Island, as well as by its private citizens. After the hurricane hit our shores recently,
                                    we all were concerned for the Okaloppo river not having a proper landline connection.
                                    But now, after Construction company finished the project, the county can enjoy its new,
                                    beautiful infrastructure!</p>
                            </div>
                            <p class="quote-default__cite">Benedict Arnold</p>
                        </div>
                    </div>
                </div>
            </div>
